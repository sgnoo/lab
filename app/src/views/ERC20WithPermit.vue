<template>
  <div class="container">
    ...
    <div>
      - A function permit extending ERC-20 which allows for approvals to be made
      via secp256k1 signatures.
    </div>
    <div>
    ...
    <div style="margin-top: 8px">TODO: eth_signTypedData_v4</div>
